          ...
          ((guard((context != null && context['config'] != null) ? context['config']['topicPostSort'] : null) != "most_votes") ?
            "\n\t\t\t\t" + 
              iter(guard((context != null && context['posts'] != null && context['posts'][key0] != null) ? context['posts'][key0]['events'] : null), function each(key1, index, length, value) {
                var key = key1;
                return "\n\t\t\t\t<li component=\"topic/event\" class=\"timeline-event\" data-topic-event-id=\"" + 
                  ...
                  (guard((context != null && context['posts'] != null && context['posts'][key0] != null && context['posts'][key0]['events'] != null && context['posts'][key0]['events'][key1] != null) ? context['posts'][key0]['events'][key1]['href'] : null) ?
                    "\n\t\t<a href=\"" + 
                      __escape(guard((context != null && context['config'] != null) ? context['config']['relative_path'] : null)) + 
                      __escape(guard((context != null && context['posts'] != null && context['posts'][key0] != null && context['posts'][key0]['events'] != null && context['posts'][key0]['events'][key1] != null) ? context['posts'][key0]['events'][key1]['href'] : null)) + 
                      "\">" + 
                    ...
                    "\n\t\t" + 
                      ...
                      "\n\t\t") + 
                  "\n\t\t&nbsp;\n\t</span>\n\t" + 
                  (guard((context != null && context['posts'] != null && context['posts'][key0] != null && context['posts'][key0]['events'] != null && context['posts'][key0]['events'][key1] != null) ? context['posts'][key0]['events'][key1]['user'] : null) ?
                    "\n\t\t" + 
                      (guard((context != null && context['posts'] != null && context['posts'][key0] != null && context['posts'][key0]['events'] != null && context['posts'][key0]['events'][key1] != null && context['posts'][key0]['events'][key1]['user'] != null) ? context['posts'][key0]['events'][key1]['user']['system'] : null) ?
                        "\n\t\t<span class=\"timeline-text\">[[global:system-user]]</span>&nbsp;\n\t\t" :
                        "\n\t\t<span><a href=\"" + 
                          __escape(guard((context != null && context['config'] != null) ? context['config']['relative_path'] : null)) + 
                          "/user/" + 
                          __escape(guard((context != null && context['posts'] != null && context['posts'][key0] != null && context['posts'][key0]['events'] != null && context['posts'][key0]['events'][key1] != null && context['posts'][key0]['events'][key1]['user'] != null) ? context['posts'][key0]['events'][key1]['user']['userslug'] : null)) + 
                          "\">" + 
                          __escape(helper(context, helpers, 'buildAvatar', [guard((context != null && context['posts'] != null && context['posts'][key0] != null && context['posts'][key0]['events'] != null && context['posts'][key0]['events'][key1] != null) ? context['posts'][key0]['events'][key1]['user'] : null), "xs", guard((context != null) ? context['true'] : null)])) + 
                          " &nbsp; " + 
                          __escape(guard((context != null && context['posts'] != null && context['posts'][key0] != null && context['posts'][key0]['events'] != null && context['posts'][key0]['events'][key1] != null && context['posts'][key0]['events'][key1]['user'] != null) ? context['posts'][key0]['events'][key1]['user']['username'] : null)) + 
                          "</a></span>&nbsp;\n\t\t") + 
                      "\n\t" :
                    "") + 
                  "\n\t<span class=\"timeago timeline-text\" title=\"" + 
                  __escape(guard((context != null && context['posts'] != null && context['posts'][key0] != null && context['posts'][key0]['events'] != null && context['posts'][key0]['events'][key1] != null) ? context['posts'][key0]['events'][key1]['timestampISO'] : null)) + 
                  "\"></span>\n\n\t" + 
                  (guard((context != null && context['privileges'] != null) ? context['privileges']['isAdminOrMod'] : null) ?
